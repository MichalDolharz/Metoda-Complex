...
# tworzy stringa by go wyswietlic w liscie ograniczen kostki
...
logs_layout = [
    ...
    [sg.Submit("Uruchom", size=(20, 3)), sg.Push(), sg.Submit("Odśwież", key="odswiez-wykres", size=(10, 1)), sg.Submit("Wyczyść", key="Wyczysc-logi", size=(10, 1))]]
